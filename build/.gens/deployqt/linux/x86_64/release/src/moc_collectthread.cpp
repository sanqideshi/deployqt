/****************************************************************************
** Meta object code from reading C++ file 'collectthread.h'
**
...
#include <memory>
#include "../../../../../../../src/collectthread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'collectthread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 7), // "collect"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "CollectThread\0collect\0"
};
...
void CollectThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CollectThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->collect(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CollectThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CollectThread::collect)) {
                *result = 0;
                return;
            }
        }
