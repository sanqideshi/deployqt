...
QT_MOC_LITERAL(1, 14, 5), // "mstop"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "ControlThread\0mstop\0"
};
...
void ControlThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ControlThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mstop(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ControlThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlThread::mstop)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ControlThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_ControlThread.data,
    qt_meta_data_ControlThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
