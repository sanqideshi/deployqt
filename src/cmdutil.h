...
public:
    ...
    static bool exec(QString workDirectorty,QString cmd, QString &standard, QString &error);
    static bool execShell(QString shell, QString &standard, QString &error);
    static bool execShell(QString& workDirectorty,QString shell, QString &standard, QString &error);
signals:
